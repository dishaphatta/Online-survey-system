...
from registerpage import Email
# pip install pymysql
class Login_Window:
	...
	def dashboard(self):
		if self.txt_email.get()=="" or self.txt_pass_.get()=="":
			...
			connectiondb = mysql.connector.connect(host="localhost",user="root",passwd="",database="surveysystem")
			cursordb = connectiondb.cursor()
			sql="select * from user WHERE Email =%s ,password = %s"

			cursordb.execute(sql,[(Email),(passs)])
